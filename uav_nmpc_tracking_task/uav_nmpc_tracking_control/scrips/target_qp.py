...
def quadratic_progamming():
    ...
    estimate_sub = rospy.Subscriber('/estimate_data'+uav_num, output, callback, queue_size=1)
    box_sub = rospy.Subscriber('/uav'+uav_num+'/YOLO/box', Float32MultiArray, callback2, queue_size=1)
