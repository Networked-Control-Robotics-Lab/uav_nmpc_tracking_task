...
desired_angle = pi/2
#Desired state value
#sd_ = DM([(cx+ 0.2*image_width - cx)/fx, ((cy + 0.15*image_height) - cy)/fy, 1./desired_distance, desired_angle])    
...
def callback(msg1,msg2,msg3):
    ...
    while msg2.name[drone_idx] != 'iris_1':        
...
pub = rospy.Publisher('/uav'+uav_num+'/nmpc/cmd_vel', TwistStamped, queue_size=1)
#pub = rospy.Publisher('/uav'+uav_num+'/setpoint_velocity/cmd_vel', TwistStamped, queue_size=1)
